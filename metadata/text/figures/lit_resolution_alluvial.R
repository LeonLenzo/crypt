#!/usr/bin/env Rscript
# metadata/classify/figures/lit_resolution_alluvial.R — literature resolution funnel (ggalluvial)
#
# Reads metadata/text/figures/lit_resolution_data.tsv (built by
...
#
# Run from crypt/: Rscript metadata/classify/figures/lit_resolution_alluvial.R
...
IN_TSV  <- "metadata/text/figures/lit_resolution_data.tsv"
OUT_PNG <- "metadata/text/figures/lit_resolution_alluvial.png"
OUT_SVG <- "metadata/text/figures/lit_resolution_alluvial.svg"

...
Outputs:
  metadata/meta_search/data/bioprojects.json  — title, description,
  ...
  metadata/meta_search/data/biosamples.json   — BioSample XML/ENA attrs

Cache:
  metadata/meta_search/data/bp_cache.json      — per-BP, resumable
  metadata/meta_search/data/bs_cache.json       — per-BioSample, resumable
  metadata/meta_search/data/serper_cache.json   — raw Serper results
...
OUT_DIR  = Path("metadata/meta_search")

...
STAT_CACHE = Path("stat/stat_fetch/data/stat_cache.jsonl")
RUNS_TSV   = Path("stat/stat_filter/data/runs.tsv")
MAL_ACCS   = Path("stat/stat_fetch/data/mal_accessions.txt")
HAL_ACCS   = Path("stat/stat_fetch/data/hal_accessions.txt")
OUT_TSV    = Path("stat/stat_filter/figures/scatter_data.tsv")

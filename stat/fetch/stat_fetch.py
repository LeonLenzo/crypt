#!/usr/bin/env python3
"""
stat/fetch.py — fetch SRA run IDs + NCBI STAT taxonomy.
...
No retention gate is applied here — that belongs in stat/filter.py.

Output (stat/fetch/data/):
...
Run from crypt/:
    python stat/fetch.py --mode mal
    python stat/fetch.py --mode hal
    python stat/fetch.py --mode mal --count
"""

...
Run from crypt/: python kraken/utilities/pilot/kallisto/run_kallisto.py
...
PILOT_DIR  = Path("kraken/utilities/pilot/kallisto")
...
RUNS_TSV   = Path("kraken/utilities/pilot/kallisto/pilot_runs.tsv")

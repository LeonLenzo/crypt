...
Usage:
  python kraken/utilities/benchmark_download.py --runs 20 --n-reads 500000 --workers 1 4 8
  python kraken/utilities/benchmark_download.py --runs 20 --methods ena-ftp ena-https --workers 1 8
  python kraken/utilities/benchmark_download.py --run-list kraken/control/output/data/run_ids.txt \\
...
def main() -> None:
    ...
    ap.add_argument("--out",      default="kraken/utilities/benchmark_download/data/benchmark.tsv",
                    help="Output TSV path (default: kraken/utilities/benchmark_download/data/benchmark.tsv)")
    args = ap.parse_args()

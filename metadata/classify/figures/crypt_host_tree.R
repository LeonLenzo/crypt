...
# Run from crypt/ : Rscript metadata/classify/figures/crypt_host_tree.R
#
...
NWK      <- "metadata/classify/figures/crypt_host_tree.nwk"
META     <- "metadata/classify/figures/crypt_host_tree_meta.tsv"
OUT      <- "metadata/classify/figures/crypt_host_tree"

...
Run from crypt/: python kraken/utilities/saturation/figures/kraken_saturation_curves.py
Output: kraken/utilities/saturation/figures/saturation_curves.pdf + .png
"""
...
DATA_DIR = Path("kraken/utilities/saturation/data")
OUT_DIR  = Path("kraken/utilities/saturation/figures")

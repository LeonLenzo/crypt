...
# Output: kraken/db/utilities/busco/figures/busco_completeness.pdf + .png
...
scores <- read.delim("kraken/db/utilities/busco/data/busco_scores.tsv", stringsAsFactors = FALSE) |>
...
out_dir <- "kraken/db/utilities/busco/figures"

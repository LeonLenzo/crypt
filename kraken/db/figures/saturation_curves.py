...
Output: kraken/output/figures/saturation/saturation_curves.pdf + .png
"""
...
DATA_DIR = Path("kraken/output/db/saturation/data")
OUT_DIR  = Path("kraken/output/figures/saturation")

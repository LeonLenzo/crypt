...
# Run from crypt/: Rscript kraken/utilities/pilot/kraken/figure_kraken.R
...
dat <- read.delim("kraken/utilities/pilot/kraken/kraken_results.tsv", stringsAsFactors = FALSE) |>
  mutate(
...
ggsave("kraken/utilities/pilot/kraken/figure_kraken.pdf", combined, width = 12, height = 5)
ggsave("kraken/utilities/pilot/kraken/figure_kraken.png", combined, width = 12, height = 5, dpi = 200)
cat("Written: kraken/utilities/pilot/kraken/figure_kraken.pdf/.png\n")

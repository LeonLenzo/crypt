#!/usr/bin/env Rscript
# metadata/meta_classify/figures/lit_resolution_alluvial.R — literature resolution funnel (ggalluvial)
#
# Reads metadata/meta_text/figures/lit_resolution_data.tsv (built by
...
#
# Run from crypt/: Rscript metadata/meta_classify/figures/lit_resolution_alluvial.R
...
IN_TSV  <- "metadata/meta_text/figures/lit_resolution_data.tsv"
OUT_PNG <- "metadata/meta_text/figures/lit_resolution_alluvial.png"
OUT_SVG <- "metadata/meta_text/figures/lit_resolution_alluvial.svg"

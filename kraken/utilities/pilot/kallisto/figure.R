...
# Run from crypt/: Rscript kraken/utilities/pilot/kallisto/pilot_figure.R

library(ggplot2)
library(dplyr)
library(ggrepel)

dat <- read.delim("kraken/utilities/pilot/kallisto/results.tsv", stringsAsFactors = FALSE) |>
  mutate(
...
ggsave("kraken/utilities/pilot/kallisto/pilot_figure.pdf", p, width = 7, height = 5.5)
ggsave("kraken/utilities/pilot/kallisto/pilot_figure.png", p, width = 7, height = 5.5, dpi = 200)
cat("Written: kraken/utilities/pilot/kallisto/pilot_figure.pdf/.png\n")

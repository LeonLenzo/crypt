...
NODES_TSV <- "metadata/output/figures/guilds/field_hc_all_nodes.tsv"
EDGES_TSV <- "metadata/output/figures/guilds/field_hc_all_edges.tsv"
OUT_PDF   <- "metadata/output/figures/guilds/wheat_cluster_plain.pdf"
OUT_PNG   <- "metadata/output/figures/guilds/wheat_cluster_plain.png"

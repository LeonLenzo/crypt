#!/usr/bin/env python3
"""
stat/build.py — build the PHI-base reference database.
...
Output: stat/build/data/phibase_db.json
...
Run from crypt/:
    python stat/build.py
    python stat/build.py --fetch   # force re-download PHI-base CSV
"""

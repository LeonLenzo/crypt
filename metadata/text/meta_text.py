#!/usr/bin/env python3
"""
metadata/text.py  —  Full manuscript retrieval: PMC OA text, Unpaywall +
...
Run from crypt/:
  python metadata/text.py --fetch
  python metadata/text.py --fetch --limit 10
  python metadata/text.py --ingest-manual
  python metadata/text.py --ingest-manual --write-retrieved
  python metadata/text.py --apply
  python metadata/text.py --report
"""
...
def cmd_fetch(workers: int, limit: int, max_chars: int) -> None:
    ...
    print()
    print("Run  python metadata/text.py --apply  to write into bioprojects.json")

#!/usr/bin/env Rscript
# figure/guilds/field_all_fungi_hulls.R
# Fungi-only co-infection network with host hulls, all field co-infections (same-genus secondaries included)
# (same-genus secondaries included, same_genus_secondary=False). Run from crypt/.
...
NODES_TSV      <- "metadata/output/figures/guilds/field_all_nodes.tsv"
EDGES_TSV      <- "metadata/output/figures/guilds/field_all_edges.tsv"
NODE_HOSTS_TSV <- "metadata/output/figures/guilds/field_all_node_hosts.tsv"
OUT_PDF        <- "metadata/output/figures/guilds/field_all_fungi_hulls.pdf"
OUT_PNG        <- "metadata/output/figures/guilds/field_all_fungi_hulls.png"
...
p <- ggraph(layout) +
  ...
  labs(
    title    = "Fungal co-infection guilds - field samples (all co-infections)",
    subtitle = paste0(
      "Nodes = fungal pathogens; edges = co-occurrence in same field biosample (same-genus secondaries included)\n",

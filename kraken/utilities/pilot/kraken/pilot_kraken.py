...
present in kraken/utilities/pilot/kraken/refs/ (same references used by the kallisto pilot),
...
Run from crypt/ with kraken2 conda env active:
    ...
    python kraken/utilities/pilot/kraken/utilities/pilot_kraken.py
    python kraken/utilities/pilot/kraken/utilities/pilot_kraken.py --skip-build   # DB already built
    python kraken/utilities/pilot/kraken/utilities/pilot_kraken.py --runs 5       # test first 5 runs
"""
...
PILOT_DIR    = Path("kraken/utilities/pilot/kraken")

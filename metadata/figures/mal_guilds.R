...
NODES_TSV <- "metadata/output/figures/guilds/mal_guild_nodes.tsv"
EDGES_TSV <- "metadata/output/figures/guilds/mal_guild_edges.tsv"
OUT_PDF   <- "metadata/output/figures/guilds/mal_guild_network.pdf"
OUT_PNG   <- "metadata/output/figures/guilds/mal_guild_network.png"

...
Inputs:
  stat/stat_build/data/phibase_db.json
  stat/stat_fetch/data/stat_cache.jsonl   (new object format)
  stat/stat_fetch/data/{mode}_accessions.txt

Output:
  stat/stat_filter/data/runs.tsv
...
OUT_DIR    = Path("stat/stat_filter")
DB_PATH    = Path("stat/stat_build/data/phibase_db.json")
JSONL_PATH = Path("stat/stat_fetch/data/stat_cache.jsonl")
ACC_DIR    = Path("stat/stat_fetch/data")

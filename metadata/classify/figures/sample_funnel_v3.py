#!/usr/bin/env python3
"""
metadata/classify/figures/sample_funnel_v3.py — Sample funnel Sankey, built on meta_classify.py
output (full manuscript text classification), superseding sample_funnel_v2.py.

Reads: metadata/classify/data/samples.tsv
...
Run from crypt/:  python metadata/classify/figures/sample_funnel_v3.py
"""
...
OUT_HTML    = Path("metadata/classify/figures/sample_funnel_v3.html")
OUT_SVG     = Path("metadata/classify/figures/sample_funnel_v3.svg")
OUT_PNG     = Path("metadata/classify/figures/sample_funnel_v3.png")

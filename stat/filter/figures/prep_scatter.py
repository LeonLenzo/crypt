...
gate criteria used in stat/filter.py:
...
STAT_CACHE = Path("stat/fetch/data/stat_cache.jsonl")
RUNS_TSV   = Path("stat/filter/data/runs.tsv")
MAL_ACCS   = Path("stat/fetch/data/mal_accessions.txt")
HAL_ACCS   = Path("stat/fetch/data/hal_accessions.txt")
OUT_TSV    = Path("stat/filter/figures/scatter_data.tsv")

...
Run from crypt/:
    python kraken/utilities/saturation.py \\
...
Outputs:
    kraken/utilities/saturation/data/sketches/{accession}.npy   (gitignored — cache)
    kraken/utilities/saturation/data/sketch_index.tsv           (tracked — what was sketched)
    kraken/utilities/saturation/data/saturation_curve.tsv       (tracked — the curves)
    kraken/utilities/saturation/data/saturation_summary.tsv     (tracked — one row per taxon)
"""
...
BUSCO_TSV = Path("kraken/utilities/busco/data/busco_scores.tsv")

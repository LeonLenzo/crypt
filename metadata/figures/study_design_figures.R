...
OUTDIR <- "metadata/output/figures/study_design"
...
d1 <- read.delim("metadata/output/figures/study_design/treat_setting_rates.tsv", stringsAsFactors = FALSE)
...
d2 <- read.delim("metadata/output/figures/study_design/single_bp_rates.tsv", stringsAsFactors = FALSE) %>%
  filter(n_runs >= 2) %>%

...
# Output: kraken/utilities/busco/figures/busco_completeness.pdf + .png
...
scores <- read.delim("kraken/utilities/busco/data/busco_scores.tsv", stringsAsFactors = FALSE) |>
...
out_dir <- "kraken/utilities/busco/figures"

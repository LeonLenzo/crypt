#!/usr/bin/env python3
"""
metadata/classify/figures/prep_lit_resolution.py — prep data for lit_resolution_alluvial.R
...
Output: metadata/text/figures/lit_resolution_data.tsv
  columns: BioProject, search, text, outcome

Run from crypt/: python metadata/classify/figures/prep_lit_resolution.py
"""
...
BIOPROJECTS_PATH = Path("metadata/search/data/bioprojects.json")
TEXT_CACHE_PATH  = Path("metadata/text/data/text_cache.jsonl")
OUT_DIR  = Path("metadata/text/figures")

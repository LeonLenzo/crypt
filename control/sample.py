...
KW_TSV     = ROOT / "output/04_filter_kw/data/biosample_kw.tsv"
LLM_TSV    = ROOT / "output/05_llm_classify/data/bioproject_llm.tsv"
STAT_CACHE = ROOT / "output/01_fetch_runs/data/stat_cache.jsonl"
HAL_RUNS   = ROOT / "output/01_fetch_runs/data/hal_runs.json"
MAL_RUNS   = ROOT / "output/01_fetch_runs/data/mal_runs.json"
OUT_DIR    = ROOT / "output/control/data"

...
Run from crypt/: python kraken/utilities/pilot/kallisto/select_runs.py
Output: kraken/utilities/pilot/kallisto/pilot_runs.tsv
"""
import csv
import random
...
OUT_TSV  = Path("kraken/utilities/pilot/kallisto/pilot_runs.tsv")

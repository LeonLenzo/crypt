...
validation cohort (metadata/meta_classify/data/samples.tsv, same
...
(see metadata/meta_classify/figures/sample_funnel_v3.py for that).

Must use system python3, not miniconda Python (ete3/sqlite3 incompatibility).

Run as: python3 metadata/meta_classify/figures/crypt_host_tree.py   (from crypt/)

Inputs:
  metadata/meta_classify/data/samples.tsv

Outputs:
  metadata/meta_classify/figures/crypt_host_tree.nwk
  metadata/meta_classify/figures/crypt_host_tree_meta.tsv
"""
...
SAMPLES_TSV         = Path("metadata/meta_classify/data/samples.tsv")
OUT_NWK             = Path("metadata/meta_classify/figures/crypt_host_tree.nwk")
OUT_META            = Path("metadata/meta_classify/figures/crypt_host_tree_meta.tsv")

...
def main() -> None:
    ...
    if args.all_hosts:
        nodes_tsv      = Path("metadata/output/figures/guilds/field_hc_all_nodes.tsv")
        edges_tsv      = Path("metadata/output/figures/guilds/field_hc_all_edges.tsv")
        node_hosts_tsv = Path("metadata/output/figures/guilds/field_hc_all_node_hosts.tsv")
    elif args.no_hc:
        nodes_tsv      = Path("metadata/output/figures/guilds/field_all_nodes.tsv")
        edges_tsv      = Path("metadata/output/figures/guilds/field_all_edges.tsv")
        node_hosts_tsv = Path("metadata/output/figures/guilds/field_all_node_hosts.tsv")
    else:
        nodes_tsv      = Path("metadata/output/figures/guilds/field_hc_nodes.tsv")
        edges_tsv      = Path("metadata/output/figures/guilds/field_hc_edges.tsv")
        node_hosts_tsv = Path("metadata/output/figures/guilds/field_hc_node_hosts.tsv")
